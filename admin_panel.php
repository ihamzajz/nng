...
body.page-admin-panel .panel-head { display:flex; align-items:center; gap:12px; }
body.page-admin-panel .panel-head-icon { width:42px; height:42px; border-radius:12px; display:flex; align-items:center; justify-content:center; background:linear-gradient(135deg, #dbeafe, #e9f7ef); color:#2563eb; border:1px solid #cfe1ff; font-size:17px; flex:0 0 auto; }
...
body.page-admin-panel .tool-head { display:flex; align-items:center; gap:12px; }
...
body.page-admin-panel .tool-title { margin:0; color:#13233f; font-size:15px; font-weight:700; }
...
<main class="app panel-shell">
    <div class="panel-box">
        <div class="panel-head">
            <div class="panel-head-icon"><i class="fa-solid fa-user-shield"></i></div>
            <h1>Admin Panel</h1>
        </div>
    </div>
    ...
    <div class="tool-grid">
        ...
        <a href="<?php echo htmlspecialchars(app_url('manage_court'), ENT_QUOTES, 'UTF-8'); ?>" class="tool-card">
            <div class="tool-head">
                <div class="tool-icon"><i class="fa-solid fa-table-tennis-paddle-ball"></i></div>
                <div class="tool-title">Manage Courts</div>
            </div>
            <div class="tool-copy">Add, edit, and delete courts with names and images for the booking system.</div>
        </a>

        <a href="<?php echo htmlspecialchars(app_url('manage_event'), ENT_QUOTES, 'UTF-8'); ?>" class="tool-card">
            <div class="tool-head">
                <div class="tool-icon"><i class="fa-solid fa-calendar-days"></i></div>
                <div class="tool-title">Manage Events</div>
            </div>
            <div class="tool-copy">Add, edit, and delete event venues with names and images for event booking.</div>
        </a>
    </div>
</main>
</body>
