...
<body id="top" class="page-contactus">
            ...
            <div class="row g-4 mb-5">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="contact-card animate-on-scroll" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="mt-4">
                            <p><i class="bi bi-clock me-2 style-contactus-001"></i> <strong>Open Today:</strong> 6:00 AM - 10:00 PM</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="contact-card animate-on-scroll" data-aos="fade-up" data-aos-delay="500">
                        ...
                        <div class="row">
                            <div class="col-md-4 text-center">
                                ...
                                <h5 class="mt-3">Parking Facilities</h5>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-4" data-aos="fade-right">
                        <img src="assets/images/NNG.png" alt="Logo" class="mb-3 style-contactus-002">
